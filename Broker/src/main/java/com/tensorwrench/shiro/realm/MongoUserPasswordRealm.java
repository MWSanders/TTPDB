...
public class MongoUserPasswordRealm extends AuthorizingRealm {
	//public static final String DEFAULT_AUTH_FIELD="";
	public static final String DEFAULT_NAME_FIELD="name";
	public static final String[] DEFAULT_PASSWORD_FIELD=new String[] {"password"};
	public static final String[] DEFAULT_SALT_FIELD=new String[] {"salt"};
	...
	public AuthenticationInfo findPasswordForUsername(String username) {
		DBObject obj=collection.findOne(
				new BasicDBObject(DEFAULT_NAME_FIELD,username)
		);
